...
public class VkOAuth2UserService extends DefaultOAuth2UserService {
    private final String CLIENT_NAME = "Vk";
    ...
    private Converter<OAuth2UserRequest, RequestEntity<?>> requestEntityConverter = new VkOAuth2UserRequestEntityConverter();
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if(!userRequest.getClientRegistration().getClientName().equalsIgnoreCase(CLIENT_NAME))
